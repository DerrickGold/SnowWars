...
public class NuajEditor : Editor
{
	...
	public override void	OnInspectorGUI()
	{
		...
		// Setting our target dirty is slow as hell for some reason !
		// In the Unity doc, it's said the SetDirty() marks the object for serialization,
		//	I supppose my manager is too heavy to serialize on each GUI change ?
		if ( GUI.changed )
