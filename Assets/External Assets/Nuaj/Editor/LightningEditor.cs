...
public class LightningEditor : Editor
{
	...
	public override void	OnInspectorGUI()
	{
		...
		T.Intensity = GUIHelpers.Slider( new GUIContent( "Intensity", "Changes the intensity of the lighning" ), T.Intensity, 0.0f, 500.0f, "Change Lightning Intensity" );
		...
		if ( GUIHelpers.Button( new GUIContent( "STRIKE !" ) ) )
			T.StartStrike( 50.0f, 2.0f, 10.0f );
		T.UpdateStrike();
