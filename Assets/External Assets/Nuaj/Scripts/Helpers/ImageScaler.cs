...
{
	/// <summary>
	/// The ImageScaler class is used to retrieve the average luminace of an image so this luminance is later used in the tone mapping stage to adapt an HDR image into a LDR result useable by Unity
	/// </summary>
