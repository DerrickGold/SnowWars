...
namespace Nuaj
{
	...
	public class ModuleCloudLayer : ModuleCloudLayerBase
	{
		...
		public class	CloudLayer : CloudLayerBase
		{
			...
			protected const float	DEFAULT_DENSITY = 0.1f;
			protected const float	DEFAULT_SMOOTHNESS = 3.0f;
			protected const float	DEFAULT_NORMAL_AMPLITUDE = 0.15f;
			...
			protected const float	DEFAULT_FACTOR_SC0 = 1.5f;
			protected const float	DEFAULT_FACTOR_SC1 = 5.0f;
			protected const float	DEFAULT_FACTOR_SC2 = 40.0f;
			protected const float	DEFAULT_FACTOR_SC3p = 5.0f;
			protected const float	DEFAULT_FACTOR_SKY = 10.0f;
			protected const float	DEFAULT_FACTOR_TERRAIN = 5.5f;
