...
public class	NuajOrchestrator : MonoBehaviour
{
	...
	protected struct	Cloud3DValues
	{
		...
		public float	CoverageOffset, CoverageContrast, Density, BevelSoftness;
		public float	NoiseTiling;
		public float	NoiseAmplitude, NoiseFrequency;
		...
		public static void		Lerp( ref Cloud3DValues a, ref Cloud3DValues b, ref Cloud3DValues _Target, float t )
		{
			...
			if ( a.Enabled && !b.Enabled )
			{
				...
				_Target.Density=NuajOrchestrator.Lerp( a.Density, 2.5f, t );
				_Target.ShadowOpacity=a.ShadowOpacity;
				_Target.CoverageOffset=a.CoverageOffset;
				_Target.CoverageContrast=a.CoverageContrast;
				_Target.BevelSoftness=a.BevelSoftness;
				_Target.NoiseTiling=a.NoiseTiling;
				_Target.NoiseAmplitude=a.NoiseAmplitude;
				_Target.NoiseFrequency=a.NoiseFrequency;
			}
			else if ( !a.Enabled && b.Enabled )
			{
				...
				_Target.Density=NuajOrchestrator.Lerp( 2.5f, b.Density, t );
				_Target.ShadowOpacity=b.ShadowOpacity;
				_Target.CoverageOffset=b.CoverageOffset;
				_Target.CoverageContrast=b.CoverageContrast;
				_Target.BevelSoftness=b.BevelSoftness;
				_Target.NoiseTiling=b.NoiseTiling;
				_Target.NoiseAmplitude=b.NoiseAmplitude;
				_Target.NoiseFrequency=b.NoiseFrequency;
			}
			else
			{
				_Target.Altitude=NuajOrchestrator.Lerp( a.Altitude, b.Altitude, t );
				_Target.Thickness=NuajOrchestrator.Lerp( a.Thickness, b.Thickness, t );
				_Target.ShadowOpacity=NuajOrchestrator.Lerp( a.ShadowOpacity, b.ShadowOpacity, t );
				_Target.CoverageOffset=NuajOrchestrator.Lerp( a.CoverageOffset, b.CoverageOffset, t );
				_Target.CoverageContrast=NuajOrchestrator.Lerp( a.CoverageContrast, b.CoverageContrast, t );
				_Target.Density=NuajOrchestrator.Lerp( a.Density, b.Density, t );
				_Target.BevelSoftness=NuajOrchestrator.Lerp( a.BevelSoftness, b.BevelSoftness, t );
				_Target.NoiseTiling=NuajOrchestrator.Lerp( a.NoiseTiling, b.NoiseTiling, t );
				_Target.NoiseAmplitude=NuajOrchestrator.Lerp( a.NoiseAmplitude, b.NoiseAmplitude, t );
				_Target.NoiseFrequency=NuajOrchestrator.Lerp( a.NoiseFrequency, b.NoiseFrequency, t );
			}
		...
		public void		Apply( NuajOrchestrator _Owner, ModuleCloudVolume.CloudLayer _Cloud )
		{
			...
			_Cloud.Altitude = Altitude;
			_Cloud.Thickness = Thickness;
			_Cloud.ShadowOpacity = ShadowOpacity;
			_Cloud.CoverageOffset = CoverageOffset;
			_Cloud.CoverageContrast = CoverageContrast;
			_Cloud.Density = Density;
			_Cloud.BevelSoftness = BevelSoftness;
			_Cloud.NoiseTiling = _Owner.m_NoiseTilingFactor * 0.02f * NoiseTiling;
			_Cloud.AmplitudeFactor = NoiseAmplitude;
			_Cloud.FrequencyFactor = NoiseFrequency;
	...
	[SerializeField] protected float			m_NoiseTilingFactor = 1.0f;
	...
	protected static SkyValues[]	ms_PresetsSky = new SkyValues[]
	{
		...
		// THICK_FOG
		new SkyValues() { AirDensity=DEFAULT_RAYLEIGH_DENSITY, FogDensity=200.0f },
		// VALLEY_MIST
		new SkyValues() { AirDensity=DEFAULT_RAYLEIGH_DENSITY, FogDensity=80.0f },
		// CLOUDY
		...
		// GLAMOUR
		new SkyValues() { AirDensity=18.9f, FogDensity=165.0f },
		// STORMY
	...
	protected static FogValues[]	ms_PresetsFog = new FogValues[]
	{
		...
		// MISTY
		new FogValues() { Enabled=true, Altitude=0.0f, Thickness=2.0f, MieFactor=0.12f, MieBottomRatio=0.48f, MaxDistance=3.25f, AmbientFactor=1.0f, StepSize=1.0f, NoiseTilingX=0.05f, NoiseTilingY=0.05f, NoiseAmplitude=0.5f, NoiseOffset=0.0f, DownpourStrength=0.0f },
		// THICK_FOG
		new FogValues() { Enabled=true, Altitude=-0.75f, Thickness=2.2f, MieFactor=3.0f, MieBottomRatio=1.3f, MaxDistance=5.0f, AmbientFactor=1.84f, StepSize=0.5f, NoiseTilingX=0.05f, NoiseTilingY=0.05f, NoiseAmplitude=0.5f, NoiseOffset=0.0f, DownpourStrength=0.0f },
		// VALLEY_MIST
		new FogValues() { Enabled=true, Altitude=-0.3f, Thickness=0.9f, MieFactor=2.7f, MieBottomRatio=10.0f, MaxDistance=20.0f, AmbientFactor=1.0f, StepSize=0.4f, NoiseTilingX=1.0f, NoiseTilingY=1.0f, NoiseAmplitude=0.75f, NoiseOffset=0.8f, DownpourStrength=-0.1f },
		// CLOUDY
		new FogValues() { Enabled=false },
		// HIGH_ALTITUDE_CLOUDS
		new FogValues() { Enabled=false },
		...
		new FogValues() { Enabled=false },
		// STORMY
		new FogValues() { Enabled=true, Altitude=0.0f, Thickness=3.8f, MieFactor=0.46f, MieBottomRatio=0.26f, MaxDistance=6.0f, AmbientFactor=1.0f, StepSize=0.2f, NoiseTilingX=3.5f, NoiseTilingY=0.125f, NoiseAmplitude=0.0f, NoiseOffset=-0.95f, DownpourStrength=2.0f },
		// STORM
		new FogValues() { Enabled=true, Altitude=0.0f, Thickness=4.0f, MieFactor=0.72f, MieBottomRatio=0.46f, MaxDistance=12.0f, AmbientFactor=1.0f, StepSize=0.2f, NoiseTilingX=3.5f, NoiseTilingY=0.125f, NoiseAmplitude=0.75f, NoiseOffset=-0.95f, DownpourStrength=3.0f },
	};
	...
	protected static Cloud2DValues[]	ms_PresetsCloud2D = new Cloud2DValues[]
	{
		...
		new Cloud2DValues() { Enabled=false },
		// THICK_FOG
		new Cloud2DValues() { Enabled=true, Altitude=8.0f, Thickness=0.35f, Coverage=0.28f, Density=0.09f, NoiseTiling=1.36f, NoiseFrequency=2.31f, NoiseAmplitude=0.5f },
		// VALLEY_MIST
		new Cloud2DValues() { Enabled=true, Altitude=12.0f, Thickness=0.4f, Coverage=0.0f, Density=0.082f, NoiseTiling=0.776f, NoiseFrequency=2.31f, NoiseAmplitude=0.5f },
		// CLOUDY
		new Cloud2DValues() { Enabled=true, Altitude=12.0f, Thickness=0.35f, Coverage=0.0f, Density=0.16f, NoiseTiling=0.776f, NoiseFrequency=2.31f, NoiseAmplitude=0.5f },
		// HIGH_ALTITUDE_CLOUDS
		new Cloud2DValues() { Enabled=true, Altitude=12.0f, Thickness=0.35f, Coverage=0.14f, Density=0.12f, NoiseTiling=1.36f, NoiseFrequency=2.31f, NoiseAmplitude=0.5f },
		// SUMMER_CLOUDS
		new Cloud2DValues() { Enabled=true, Altitude=12.0f, Thickness=0.35f, Coverage=-0.03f, Density=0.12f, NoiseTiling=1.36f, NoiseFrequency=2.31f, NoiseAmplitude=0.5f },
		// SNOWY
		new Cloud2DValues() { Enabled=true, Altitude=12.0f, Thickness=0.35f, Coverage=0.31f, Density=0.146f, NoiseTiling=1.36f, NoiseFrequency=2.31f, NoiseAmplitude=0.5f },
		// LIGHT_RAIN
		new Cloud2DValues() { Enabled=true, Altitude=12.0f, Thickness=0.55f, Coverage=0.36f, Density=0.04f, NoiseTiling=1.36f, NoiseFrequency=2.31f, NoiseAmplitude=0.5f },
		// GLAMOUR
		new Cloud2DValues() { Enabled=true, Altitude=12.0f, Thickness=0.35f, Coverage=-0.02f, Density=0.51f, NoiseTiling=1.23f, NoiseFrequency=2.31f, NoiseAmplitude=0.5f },
		// STORMY
		new Cloud2DValues() { Enabled=true, Altitude=12.0f, Thickness=0.38f, Coverage=0.36f, Density=0.108f, NoiseTiling=1.36f, NoiseFrequency=2.31f, NoiseAmplitude=0.5f },
		// STORM
		new Cloud2DValues() { Enabled=true, Altitude=12.0f, Thickness=0.38f, Coverage=0.17f, Density=0.1f, NoiseTiling=1.36f, NoiseFrequency=2.31f, NoiseAmplitude=0.5f },
	};
	...
	{
		// CLEAR
		new Cloud3DValues() { Enabled=true, Altitude=2.0f, Thickness=2.0f, ShadowOpacity=0.4f, CoverageOffset=-1.0f, CoverageContrast = 2.0f, Density=3.0f, BevelSoftness=1.0f, NoiseTiling=0.8f, NoiseFrequency=3.0f, NoiseAmplitude=0.5f },
		// MISTY
		new Cloud3DValues() { Enabled=true, Altitude=2.0f, Thickness=2.0f, ShadowOpacity=0.4f, CoverageOffset=-1.0f, CoverageContrast = 2.0f, Density=3.0f, BevelSoftness=1.0f, NoiseTiling=0.8f, NoiseFrequency=3.0f, NoiseAmplitude=0.5f },
		// THICK_FOG
		new Cloud3DValues() { Enabled=true, Altitude=2.0f, Thickness=2.0f, ShadowOpacity=0.4f, CoverageOffset=-1.0f, CoverageContrast = 2.0f, Density=3.0f, BevelSoftness=1.0f, NoiseTiling=0.8f, NoiseFrequency=3.0f, NoiseAmplitude=0.5f },
		// VALLEY_MIST
		new Cloud3DValues() { Enabled=true, Altitude=2.3f, Thickness=3.55f, ShadowOpacity=0.4f, CoverageOffset=-0.4f, CoverageContrast = 2.0f, Density=3.0f, BevelSoftness=1.0f, NoiseTiling=0.8f, NoiseFrequency=3.0f, NoiseAmplitude=0.4f },
		// CLOUDY
		new Cloud3DValues() { Enabled=true, Altitude=2.0f, Thickness=1.9f, ShadowOpacity=0.4f, CoverageOffset=-0.11f, CoverageContrast = 2.0f, Density=3.0f, BevelSoftness=1.0f, NoiseTiling=0.8f, NoiseFrequency=3.0f, NoiseAmplitude=0.5f },
		// HIGH_ALTITUDE_CLOUDS
		new Cloud3DValues() { Enabled=true, Altitude=3.3f, Thickness=1.9f, ShadowOpacity=0.4f, CoverageOffset=-1.0f, CoverageContrast = 2.0f, Density=3.0f, BevelSoftness=1.0f, NoiseTiling=0.8f, NoiseFrequency=3.0f, NoiseAmplitude=0.5f },
		// SUMMER_CLOUDS
		new Cloud3DValues() { Enabled=true, Altitude=1.5f, Thickness=1.0f, ShadowOpacity=0.4f, CoverageOffset=-0.3f, CoverageContrast = 2.0f, Density=3.0f, BevelSoftness=1.0f, NoiseTiling=2.5f, NoiseFrequency=3.0f, NoiseAmplitude=0.5f },
		// SNOWY
		new Cloud3DValues() { Enabled=true, Altitude=3.0f, Thickness=1.0f, ShadowOpacity=0.4f, CoverageOffset=0.17f, CoverageContrast = 2.0f, Density=3.0f, BevelSoftness=1.0f, NoiseTiling=0.8f, NoiseFrequency=3.0f, NoiseAmplitude=0.5f },
		// LIGHT_RAIN
		new Cloud3DValues() { Enabled=true, Altitude=2.5f, Thickness=1.2f, ShadowOpacity=0.4f, CoverageOffset=-0.11f, CoverageContrast = 2.0f, Density=2.5f, BevelSoftness=1.0f, NoiseTiling=1.2f, NoiseFrequency=3.0f, NoiseAmplitude=0.5f },
		// GLAMOUR
		new Cloud3DValues() { Enabled=true, Altitude=1.6f, Thickness=1.2f, ShadowOpacity=0.666f, CoverageOffset=-0.207f, CoverageContrast = 2.0f, Density=2.3f, BevelSoftness=0.375f, NoiseTiling=1.5f, NoiseFrequency=3.0f, NoiseAmplitude=0.5f },
		// STORMY
		new Cloud3DValues() { Enabled=true, Altitude=2.0f, Thickness=1.8f, ShadowOpacity=0.4f, CoverageOffset=-0.16f, CoverageContrast = 2.0f, Density=2.5f, BevelSoftness=1.0f, NoiseTiling=1.0f, NoiseFrequency=3.0f, NoiseAmplitude=0.5f },
		// STORM
		new Cloud3DValues() { Enabled=true, Altitude=2.0f, Thickness=2.0f, ShadowOpacity=0.4f, CoverageOffset=0.0f, CoverageContrast = 2.0f, Density=2.5f, BevelSoftness=1.0f, NoiseTiling=0.8f, NoiseFrequency=3.0f, NoiseAmplitude=0.5f },
	};
	...
	/// <summary>
	/// Gets or sets the noise tiling factor used for dramatic effects
	/// </summary>
	public float		NoiseTilingFactor
	{
		get { return m_NoiseTilingFactor; }
		set
		{
			if ( Mathf.Approximately( value, m_NoiseTilingFactor ) )
				return;

			m_NoiseTilingFactor = value;
			UpdateWeather();
		}
	}
