		...
		protected void	DisplayCloudLayer( Nuaj.ModuleCloudLayer.CloudLayer _Layer, int _LayerIndex )
		{
			...
			using ( GUIHelpers.GUIEnabler( _Layer.Enabled ) )
			{
				...
				if ( GUIHelpers.FoldOut( ref m_bFoldOutAppearance[_LayerIndex], "Appearance" ) )
				{
					...
					_Layer.Density = 0.25f * GUIHelpers.Slider( new GUIContent( "Density", "Sets the cloud's density cloud density that influences the capacity of the cloud to absorb and scatter light." ), 4.0f * _Layer.Density, 0.0f, MAX_DENSITY, "Change Cloud Density" );
				...
				if ( GUIHelpers.FoldOut( ref m_bFoldOutAdvanced[_LayerIndex], "Advanced" ) )
				{
					...
					_Layer.FactorSingleScattering = GUIHelpers.Slider( new GUIContent( "Single Scattering", "Sets the single scattering factor." ), _Layer.FactorSingleScattering, 0.0f, 10.0f, "Change Single Scattering Factor" );
					_Layer.FactorDoubleScattering = GUIHelpers.Slider( new GUIContent( "Double Scattering", "Sets the double scattering factor." ), _Layer.FactorDoubleScattering, 0.0f, 100.0f, "Change Double Scattering Factor" );
					_Layer.FactorMultipleScattering = GUIHelpers.Slider( new GUIContent( "Multiple Scattering", "Sets the multiple scattering factor." ), _Layer.FactorMultipleScattering, 0.0f, 10.0f, "Change Single Scattering Factor" );
					_Layer.FactorSkyColor = GUIHelpers.Slider( new GUIContent( "Sky Scattering", "Sets the sky scattering factor for sky light passing though the clouds." ), _Layer.FactorSkyColor, 0.0f, 10.0f, "Change Sky Scattering Factor" );
					_Layer.FactorTerrainColor = GUIHelpers.Slider( new GUIContent( "Terrain Scattering", "Sets the terrain scattering factor for light reflected on the terrain." ), _Layer.FactorTerrainColor, 0.0f, 10.0f, "Change Terrain Scattering Factor" );
